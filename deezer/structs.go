...
type Deezer_track_search struct {
	Data []struct {
		ID                    int64  `json:"id"`
...
type Deezer_album_search struct {
	Data []struct {
		ID             int    `json:"id"`
		Title          string `json:"title"`
		Link           string `json:"link"`
...
type Deezer_artist_albums struct {
	Data []struct {
		ID             int    `json:"id"`
		Title          string `json:"title"`
		Link           string `json:"link"`
...
type Deezer_playlist_track struct {
	Data []struct {
		ID                    int    `json:"id"`
		Readable              bool   `json:"readable"`
		Title                 string `json:"title"`
